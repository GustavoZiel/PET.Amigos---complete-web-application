    ...
    <section>
        <div class="container-fluid row bg-light">
            ...
            <div class="col-12 col-md-5 d-flex justify-content-center py-4 pt-md-0">
                <img src="img/tuka.png" alt="Foto da ONG" class="h-100 rounded-4 img-border img-fluid"></img>
            </div>
                        ...
                        <form method="POST" action="/pets" enctype="multipart/form-data">
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="birth" name="birth" required></input>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input class="form-control" type="file" id="formFileMultiple" name="photos" multiple></input>
                                </div>
                            </div>
                            ...
                            <div class="row my-4">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="comment" name="comment" style={{height: 100}} required></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 align-items-end">
                                ...
                                <div class="col-auto">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="temperament" value="docil"></input>
                                        <label class="form-check-label" for="inlineCheckbox1">Dócil</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="temperament" value="brincalhao"></input>
                                        <label class="form-check-label" for="inlineCheckbox2">Brincalhão</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="temperament" value="timido"></input>
                                        <label class="form-check-label" for="inlineCheckbox3">Tímido</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="temperament" value="agitado"></input>
                                        <label class="form-check-label" for="inlineCheckbox3">Agitado</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="temperament" value="carinhoso"></input>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="vacinatedYes" name="vacinated" value="1"></input>
                                        <label class="form-check-label" for="vacinatedYes">Sim</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="vacinatedNo" name="vacinated" value="0"></input>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="adoptedYes" name="adopted"></input>
                                        <label class="form-check-label" for="adoptedYes">Sim</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="adoptedNo" name="adopted"></input>
        ...
        <div class="row pt-4">
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 pb-4">
                <div class="card rounded-5">
                    <img src="img/Pitstop.png" class="card-img-top img-fluid rounded-top-5 img-border" alt="Pitstop"></img>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 pb-4">
                <div class="card rounded-5">
                    <img src="img/Gup.png" class="card-img-top img-fluid rounded-top-5 img-border" alt="Pitstop"></img>
                    <div class="card-body rounded-bottom-5 card-border">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 pb-4">
                <div class="card rounded-5">
                    <img src="img/Ney.png" class="card-img-top img-fluid rounded-top-5 img-border" alt="Pitstop"></img>
                    <div class="card-body rounded-bottom-5 card-border">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 pb-4">
                <div class="card rounded-5">
                    <img src="img/Monteiro.png" class="card-img-top img-fluid rounded-top-5 img-border" alt="Pitstop"></img>
                    <div class="card-body rounded-bottom-5 card-border">
                        <div class="card-title card-font-name">Monteiro</div>
                        <div class="card-text card-font-info">Belo Horizonte</div>
                        <div class="d-flex align-items-center">
                            <i class="fa-solid fa-heart fa-lg"></i>
                            <div class="ms-1 card-font-info">Dócil</div>
                        </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 pb-4">
                <div class="card rounded-5">
                    <img src="img/Nelso.png" class="card-img-top img-fluid rounded-top-5 img-border" alt="Pitstop"></img>
                    <div class="card-body rounded-bottom-5 card-border">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 pb-4">
                <div class="card rounded-5">
                    <img src="img/Juninho.png" class="card-img-top img-fluid rounded-top-5 img-border" alt="Pitstop"></img>
                    <div class="card-body rounded-bottom-5 card-border">
